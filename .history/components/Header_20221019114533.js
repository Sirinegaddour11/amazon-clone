  ...
  return (
    <header className="sticky top-0 z-50">
      ...
      <div className="flex items-center space-x-3 p-2 pl-6 bg-amazon_blue-light text-white text-sm">
        ...
        <p className="tooltip link hidden lg:inline-flex">
          Foods & Grocery <span class="tooltiptext">Basket</span>
        </p>
        <p className="tooltip link hidden lg:inline-flex">
          Prime <span class="tooltiptext">Basket</span>
        </p>
        <p className="tooltip link hidden lg:inline-flex">
          Buy Again<span class="tooltiptext">Basket</span>
        </p>
        <p className="tooltip link hidden lg:inline-flex">
          Shopper Toolkit<span class="tooltiptext">Basket</span>
        </p>
        <p className="tooltip link hidden lg:inline-flex">
          Health & Personal <span class="tooltiptext">Basket</span>
        </p>
      </div>
    </header>
  );
