...
function Header() {
  ...
  return (
    <header className="sticky top-0 z-50">
      ...
      <div className="flex items-center p-1 flex-grow py-2 bg-amazon_blue-light text-white">
        <div className="link flex items-center">
          <MenuIcon className="h-6 mr-1" />
        </div>
        <div className="flex items-center space-x-6 p-1 pl-3 bg-amazon_blue-light text-white link">
          ...
          <MenuItem title="Electronics" className=></MenuItem>
