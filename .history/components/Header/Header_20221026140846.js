    ...
    <header className="sticky top-0 z-50">
      ...
      <div className="flex items-center space-x-3 p-2 pl-6 bg-amazon_blue-light text-white text-sm">
        ...
        <div className="flex items-center space-x-6 p-1 pl-3 bg-amazon_blue-light text-white ">
          ...
          <MenuDropdown title="Prime Video"><MenuCarousel /></MenuDropdown>
          <MenuDropdown title="Amazon Business"><AmazonBusiness /></MenuDropdown>
                    <MenuDropdown title="Today s Deals"><AmazonBusiness /></MenuDropdown>
