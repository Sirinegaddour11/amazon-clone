...
import { modeSession, selectItems } from "../slices/basketSlice";
        ...
        <div className="text-white flex items-center text-xs space-x-6 mx-6 whitespace-nowrap">
          ...
          >
            ...
            <p className="tooltip hidden md:inline font-extrabold md:text-sm mt-2 ">
              Basket
              <span className="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                Basket
              </span>
            </p>
          </div>
