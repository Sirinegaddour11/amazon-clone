...
function AmazonBusiness() {
      ...
      const AmazonBusiness = [
        {
          id: "1",
          title: " Arm your organization Drive procurement agilitywith increased visibility, more responsible and sustainable options, and greater efficiencies so your organization can do more.",
          image:
