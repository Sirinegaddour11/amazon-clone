      ...
      const AmazonBusiness = [
        {
          ...
          image:
            ...
            description :"  Arm your organization with increased visibility, more responsible and sustainable options, and greaterefficiencies so your organization can do more."
        },
      ];
  return (
    <div className="flex">
      ...
      <Menu key={AmazonBusiness.id} id={id} title={title} image={image} />
      {description}
    </div>
  );
}
