  ...
  return (
    <header className="sticky top-0 z-50">
      ...
      <div className="  flex items-center space-x-3 p-2 pl-6 bg-amazon_blue-light text-white text-sm">
        ...
        <div className="flex items-center space-x-3 p-2 pl-6 bg-amazon_blue-light text-white text-sm">
          <MenuItem title="Prime Video">
            <Data />
          </MenuItem>
          <MenuItem title="Amazon Business">
            <AmazonBusiness />
          </MenuItem>
          <MenuItem title=" Today s Deals">
          <Today />
          </MenuItem>
          <MenuItem title="Electronics"/>
          <Data /></MenuItem>
          <MenuItem title="Foods & Grocery"/>
           <MenuItem title="Prime">  <MenuItem title="Buy Again">  <MenuItem title="Shopper Toolkit"> Health & Personal Care">
        </div>
      </div>
    </header>
  );
